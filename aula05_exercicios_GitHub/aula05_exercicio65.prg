...
Function Main()
    ...
    WHILE .T.
        ...
        IF len(cUsuario) < 6
            QOUT("Seu usuario deve possuir mais do que 5 caracteres")
        ELSE
            EXIT
        ENDIF
    ENDDO
    ...
    WHILE .T. 
        ...
        IF len(cSenha) < 6
            QOUT("Sua senha deve possuir mais do que 5 caracteres")
        ELSEIF !TesteSenha(cSenha)
            QOUT("Sua senha deve possuir ao menos uma letra maiuscula, um digito numerico e um simbolo")
        ELSE
            EXIT
        ENDIF
    ENDDO
    ...
    WHILE .T.
        ACCEPT "Repita sua senha: " TO cSenha2
        IF cSenha == cSenha2
            EXIT
        ELSE
