...
Function isLetra(cMSG) //Funcionando é um codigo que testa pra ver se a string esta vazia e usa ISALPHA para percorrer toda a string
...
Function isDigito(nMSG) //Funcionando é um codigo que testa pra ver se a string esta vazia e usa ISDIGIT para percorrer toda a string
...
Function isSimbolo(cMSG) // Funcionando, codigo que testa pra ver se a string esta vazia percorre toda a string vendo se tudo dentro dela é simbolo
